                            ...
                            <div class="shipping-details">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <input id="street_2" type="text" class="form-control" placeholder="Apartment, suite, unit etc. (optional)" name="street_2" value="{{ old('street_2') }}" />
                                        </div>
                                    </div>
                            ...
                            <?php if ($dataWithAutoShip['countOfAutoshipProducts']) { ?>
                                <div class="checkout_autoship_wrap">
                                    <div class="checkout_autoship">
                                        <h2>
                                            Start <span class="autoship">Autoship</span> save an extra 20% on today's order, plus save 5% off eligible items on all Autoship orders?
                                            <a href="javascript:void(0);" data-toggle="modal" data-target="#first-autoship-model" class="learn-more">More Info</a>
                                        </h2> 
