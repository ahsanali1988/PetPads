...
@section('content')
                                            ...
                                            <div class="product">
                                                ...
                                                <div class="product-details text-center">
                                                    ...
                                                    <div class="glyphicon-star-rating"
                                                         title="{{ $product->avg_rating }} out of 5">
                                                        <div class="ratingPreview"
                                                             data-rateyo-rating="{{ $product->avg_rating }}"></div>
                                                        <span class="review-count-total">{{ $product->reviews_count }}
                                                            Reviews</span>
                                                    </div>
                                                    @if($maxOffer)
                                                        <div class="price">
                                    ...
                                    <ul class="list list-border angle-double-right">
                                        @if(!is_null($nav_categories) && count($nav_categories) > 0)
                                            @foreach($nav_categories as $category)
                                                <li class="{{ isset($page) && $page == $category->slug ? 'active' : '' }} red_bg">
                                                    <a href="{{ route('category', ['slug' => $category->slug]) }}">{{ $category->name }}
            ...
            <div class="row">
                <div class="call-to-action pt-30 pb-20">
                    ...
                    <div class="col-md-3 text-right flip sm-text-center">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#modal-window-choose" class="btn btn-theme-colored btn-circled btn-lg font-20">See Our Chart <i
    ...
    <script type="text/javascript"> function saLoadScript(src) { var js = window.document.createElement('script'); js.src = src; js.type = 'text/javascript'; document.getElementsByTagName("head")[0].appendChild(js); } saLoadScript('//www.shopperapproved.com/widgets/group2.0/27575.js'); </script>
@endsection
