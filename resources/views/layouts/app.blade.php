...
<!-- Header end -->
    ...
    <!-- Footer -->
    <footer id="footer" class="bg-black-22">
        <div class="container pt-30">
            <div class="row border-bottom-black">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="widget">
                        <h5 class="widget-title line-bottom">Why Buy From Us</h5>
                        <ul class="list angle-double-right">
                            @if(count($footer_homepage) > 0)
                                @foreach($footer_homepage as $footer)
                                    <li>
                                        <a href="{{ route('static-page', ['slug' => $footer->slug]) }}">{{ $footer->page_name }}</a>
                                    </li>
                                @endforeach
                            @endif
                        </ul>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="widget">
                        <h5 class="widget-title line-bottom">My Account</h5>
                        <ul class="list angle-double-right">
                            @if (Auth::guest())
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="widget">
                        <h5 class="widget-title line-bottom">Stay Updated!</h5>
