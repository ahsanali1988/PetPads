                ...
                <div class="section-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h3>Contact Us</h3>
                            <p><a href="{{ route('static-page', ['slug' => 'contact-us'])}}">Contact us</a> to place your order for dog training pads today. We are more than happy to assist you in any manner you require. </p>
                        </div>
                    </div>
                </div>
            </div>
